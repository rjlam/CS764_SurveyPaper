...
$R^{*}$-tree of \cite{Beckmann:1990:RER:93597.98741} is the variant most 
...
\cite{Beckmann:1990:RER:93597.98741}, the authors examine three cost functions: total area 
covered by the resultant MBRs, total margin of the resultant MBRs, and the overlapping area 
of the MBRs. Of the algorithms examined in \cite{Beckmann:1990:RER:93597.98741}, the one in 
...
contain the I/O cost. In \cite{Beckmann:1990:RER:93597.98741} we find that $R^{*}$-trees 
...
in Section~\ref{impchal} and Section~\ref{dbchal} try to improve.
